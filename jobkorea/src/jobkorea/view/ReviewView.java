...
public class ReviewView {
	...
	public ArrayList<Integer> rPassPrint(int mno) {
		System.out.println("===== ooo님 합격한 기업 리스트 =====");
	...
	public void rPrintAll(int mno) {
		System.out.println("===== ㅇㅇㅇ님 작성한 후기 리스트 =====");
	...
	public void rDelete() {
		...
		System.out.println("삭제할 후기 번호 : ");	int rno = scan.nextInt();
		ReviewDto reviewDto = new ReviewDto();
		reviewDto.setRno(rno);
		boolean result = ReviewController.getInstance().rDelete(reviewDto);
