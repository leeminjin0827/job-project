...
public class PostView {
	...
	public void pIndex( int loginEno ) {
		while( true ) {
			System.out.println("1.공고등록 2.공고수정 3.공고삭제 4.지원현황 5.내정보보기 6.로그아웃");
	...
	public void pRegister( int loginEno) {
	    System.out.print(">> 해당하는 카테고리의 번호 : ");	int cno = scan.nextInt();
	    scan.nextLine();
	    System.out.print("제목 : ");								String ptitle = scan.nextLine();
	    System.out.print("내용 : ");								String pcontent = scan.nextLine();
	    System.out.print("경력 : ");								String phistory = scan.nextLine();
	    System.out.print("모집인원 : ");							String pcount = scan.nextLine();
	    System.out.print("연봉 : ");								String psalary = scan.nextLine();
	    System.out.print("공고마감일 : ");							String pend = scan.nextLine();
	...
	public void pUpdate( ArrayList<Integer> array ) {
		System.out.print(">> 수정할 공고의 번호 : ");	int pno = scan.nextInt();
		scan.nextLine();
	    System.out.print("제목 : ");							String ptitle = scan.nextLine();
	    System.out.print("내용 : ");							String pcontent = scan.nextLine();
	    System.out.print("경력 : ");							String phistory = scan.nextLine();
	    ...
	    else { System.out.println(">> 해당 공고번호가 존재하지 않습니다."); }
	} // f end
	...
	public void pCheck( ArrayList<Integer> array ) {
		...
		else { System.out.println(">> 해당 지원번호가 존재하지 않습니다."); }
	} // f end
